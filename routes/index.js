...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Television Show App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Television Show App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Television Show App Login', user : req.user }); 
}); 
